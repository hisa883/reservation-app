...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<i18n>.freeze, ["< 2", ">= 1.8.11"])
      ...
      s.add_development_dependency(%q<simplecov>.freeze, ["< 0.18", "= 0.17.1"])
      ...
      s.add_dependency(%q<i18n>.freeze, ["< 2", ">= 1.8.11"])
      ...
      s.add_dependency(%q<simplecov>.freeze, ["< 0.18", "= 0.17.1"])
